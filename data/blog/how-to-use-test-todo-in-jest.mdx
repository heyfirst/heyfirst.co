...
date: "2021-08-03"
summary: "Heyo! last week I learn someone when I do pair programming with my teammate. It's about writing Jest tests in a more make sense way. Let's talk about it!"
image: "/static/blog/best-practice-might-be-wrong/annie-spratt-f4gQ-dJ0yo8-unsplash.jpg"
tags: ["developer experience", "testing"]
---

Heyo! last week I learn someone when I do pair programming with my teammate. It's about writing Jest tests in a more make sense way.

> ⚠️ Disclaimer! I use it for a week! I don't have any downside yet!
...
Actually, this is **not a new thing**. the [`test.todo()` PR](https://github.com/facebook/jest/pull/6996) merged since Sep,
2018 and release at [Jest 24](https://jestjs.io/blog/2019/01/25/jest-24-refreshing-polished-typescript-friendly#testtodo).
...
I also know this last week since I use a lot of `test.skip()` for many years.
...
2. There are still some issue that `beforeAll` and `afterAll` get executed if `test.todo()` is present in `describe.skip` ([https://github.com/facebook/jest/issues/11006](https://github.com/facebook/jest/issues/11006))
...
I hope this will help you write the Jest test in much more make sense way which is also happened to me since last week!
